...
1. `task_list.json` — Feature status and progress
2. `progress.md` — What has been done in previous sessions
...
5. **Update state** if the change affects a feature's status in `task_list.json`:
...
7. **Update** `progress.md` with what you did this session
...
- If the instruction is ambiguous, make your best judgment and document your assumption in `progress.md`
